...
object GsmDemo {
  def main(args: Array[String]): Unit = {
    ...
    //使用 sparkSQL处理数据
//    val res1: DataFrame =dataFrame.select("networkmannername","requestmode","processnode","iseffective","isbilling",
//      "isbid","iswin","adorderid","winprice","adpayment")
//
//    res1.createOrReplaceTempView("sum_location")
//
//    val res2=sparkSession.sql("select networkmannername," +
...
//      "from sum_location group by networkmannername")
//    res2.show()
